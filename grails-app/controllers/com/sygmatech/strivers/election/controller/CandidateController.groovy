...
import com.sygmatech.strivers.election.service.VoteTallyService;
...
class CandidateController {
	...
	def vote() {
		def voteService = new VoteTallyService()
		def voteTotal = voteService.tallyVotes()
		request.setAttribute("votesummary", voteTotal)
		render(view: "../votesummary")
        return
	}
}

	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="create" action="vote"><g:message code="default.tabulate.label" /></g:link></li>
			</ul>
		</div>
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="primaryCandidate" title="${message(code: 'candidate.primaryCandidate.label', default: 'Primary Candidate')}" />
				...
				<g:each in="${candidateInstanceList}" status="i" var="candidateInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatBoolean boolean="${candidateInstance.primaryCandidate}" /></td>
